    ...
    <div class="banner-area banner-inner-1 bg-black" id="banner">
        ...
        <div class="container">
            <div class="row">
                ...
                @forelse ($aboutPosts as $aboutPost)
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-post-wrap style-white">
                            <div class="thumb">
                                <img src="{{ asset('storage/' . $aboutPost->featured_image) }}" alt="img">

                                @if ($postTags)
                                    @foreach ($postTags as $postTag)
                                        <a class="tag-base tag-orange" href="#">
                                            @if ($postTag->post_id == $aboutPost->id)
                                                {{ $postTag->tag->name }}
                                            @endif
                                        </a>
                                    @endforeach
                ...
                @empty
                    {{-- When there is NO post, show fallback card --}}
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-post-wrap style-white">
                            <div class="thumb">
                                <img src="{{ asset('frontend/assets/img/post/2.png') }}" alt="img">
                                <a class="tag-base tag-orange" href="#">Food</a>
                            </div>
                            <div class="details">
                ...
                {{-- <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-white">
                        <div class="thumb">
                            <img src="{{ asset('frontend/assets/img/post/3.png') }}" alt="img">
                    ...
                    <div class="post-slider owl-carousel">
                        <div class="item">
                            <div class="trending-post">
                                @forelse ($featuredPostsItem1 as $value)
                                ...
                                <div class="single-post-wrap style-overlay">
                                    <div class="thumb">
                                        <img src="{{ asset('frontend/assets/img/post/5.png') }}" alt="img">
                                    </div>
                                    <div class="details">
                                        <div class="post-meta-single">
                        ...
                        <div class="item">
                             <div class="trending-post">
                                @forelse ($featuredPostsItem2 as $value)
                                    <div class="single-post-wrap style-overlay">
                                        <div class="thumb">
                                            <img src="{{ asset('storage/' . $value->featured_image) }}" alt="img">
                                        </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="details">
                                            ...
                                            <h6 class="title"><a href="#">Online registration, booking for Vaishno
                                                    Devi </a></h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="details">
                                            ...
                                            <h6 class="title"><a href="#">Detecting technologies in airports this
                                                    year</a></h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="details">
                                            ...
                                            <h6 class="title"><a href="#">The FAA will drone detect-ing in airports
                                                    this year</a></h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="details">
                                            ...
                                            <h6 class="title"><a href="#">Thailand makes it mand-atory for tourists
                                                    to stay</a></h6>
                                        </div>
                                    </div>
                                </div>
