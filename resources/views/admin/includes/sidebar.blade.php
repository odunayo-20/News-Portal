 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
         ...
         <li class="nav-item">
             <a class="nav-link" href="{{ route('admin.post-tags') }}">
                 <i class="fa fa-puzzle-piece menu-icon"></i>
                 <span class="menu-title">Post Tags</span>
             </a>
         </li>
         {{-- <li class="nav-item">
             ...
             <div class="collapse" id="page-layouts">
                 <ul class="nav flex-column sub-menu">
                     <li class="nav-item d-none d-lg-block"> <a class="nav-link"
                             href="{{ route('admin.articles.create') }}">Create</a></li>
                     <li class="nav-item"> <a class="nav-link" href="{{ route('admin.articles') }}">View</a></li>
                 </ul>
             </div>
         </li> --}}
         ...
         <li class="nav-item">
             ...
             <div class="collapse" id="page-layouts">
                 <ul class="nav flex-column sub-menu">
                     <li class="nav-item d-none d-lg-block"> <a class="nav-link"
                             href="{{ route('admin.posts.create') }}">Create</a></li>
